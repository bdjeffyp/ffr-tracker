...
logic = {
  ...
  // TODO: Doesn't do anything, currently. Will add calculation of NPC availability and map updating in the future...
  apply: function () {
    // Update the checked items in the tracker depending on the goal of the game
    // TODO: Currently not functioning. Come back to this later.
    // if (settings.goal == goals.chaosRush) {
    //   // If the Lute is off, turn it on
    //   if(items.lute.val == itemState.off) {
    //     toggleIcon("lute", items);
    //   }
    // }

    // TODO: Add logic to check off all crystals if Free ORBs is turned on
  },
};